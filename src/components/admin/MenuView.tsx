      ...
      <div className="relative">
        ...
        {categories.map((cat, idx) => {
          ...
          return (
            <div
              key={cat.id}
              className="shrink-0 flex items-center gap-0.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl pl-1 pr-1.5 py-1"
            >
              <div className="flex flex-col">
                <button
                  onClick={() => store.reorderCategory(cat.id, 'up')}
                  disabled={idx === 0}
                  className="text-slate-400 hover:text-slate-900 dark:hover:text-white disabled:opacity-20 disabled:cursor-not-allowed cursor-pointer leading-none"
                  title="Monter"
                >
              ...
              <button
                ...
                className="w-6 h-6 flex items-center justify-center rounded-lg text-slate-400 hover:text-rose-600 hover:bg-slate-100 dark:hover:bg-slate-800 cursor-pointer"
